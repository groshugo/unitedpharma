<%@ Page Title="Role Management" Language="C#" MasterPageFile="~/Administrator/Admin.master"
    AutoEventWireup="true" CodeFile="RoleManagement.aspx.cs" Inherits="Administrator_Default" %>
    ...
    <telerik:RadGrid runat="server" ID="RadGrid1" AutoGenerateColumns="false" AllowPaging="true"
        ...
        <MasterTableView DataKeyNames="Id" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnCurrentPage">
            <Columns>
                ...
                <telerik:GridButtonColumn ConfirmText="Delete this role?" ConfirmDialogType="RadWindow"
