...
public partial class Administrator_Compose : System.Web.UI.Page
{
    ...
    public void RadAjaxManager1_AjaxRequest(object sender, AjaxRequestEventArgs e)
    {
        ...
        string sqlSale = "Select l.FullName as CustomerName,l.UpiCode,l.Phone, (CASE WHEN (l.FullName <> '') THEN '' ELSE '' END) as FullName,r.RoleName as PositionName FROM [Salesmen] as l LEFT JOIN [Role] as r on l.RoleId=r.Id where l.Phone in (" + e.Argument + ")";
