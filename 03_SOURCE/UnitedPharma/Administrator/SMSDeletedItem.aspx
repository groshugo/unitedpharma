<%@ Page Title="SMS Deleted Item" Language="C#" MasterPageFile="~/Administrator/SMS.master"
    AutoEventWireup="true" CodeFile="SMSDeletedItem.aspx.cs" Inherits="Administrator_SMSDeletedItem" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentCommand" runat="Server">
    ...
    <div style="margin-right: 5px; float: right; height: 35px;">
        ...
        <telerik:RadButton runat="server" ID="btnClearFilter" Skin="Office2007" Text="Clear Filter"
            ToolTip="Filter" OnClick="btnClearFilter_Click">
        </telerik:RadButton>
    </div>
    <div style="float: right; height: 35px; width: 358px;">
        ...
        <telerik:RadComboBox runat="server" ID="cbFilterType" Skin="Office2007">
            <Items>
                ...
                <telerik:RadComboBoxItem Value="1" Text="By To" />
        ...
        <telerik:RadGrid runat="server" ID="RadGrid1" AutoGenerateColumns="false" AllowPaging="true"
            ...
            <MasterTableView DataKeyNames="Id" CommandItemDisplay="None" ItemStyle-Height="30" HeaderStyle-Height="35">
                <Columns>
                    ...
                    <telerik:GridButtonColumn ConfirmText="Delete this SMS from Trash?" ConfirmDialogType="RadWindow"
