...
public partial class Administrator_SMSReply : System.Web.UI.Page
{
    ...
    protected void btnSendSMS_Click(object sender, EventArgs e)
    {
        ...
        rs = repo.GetSMSById(Convert.ToInt32(Request.QueryString["ID"]));
        var result = rs.FirstOrDefault();
        repo.InsertSMS(result.SMSCode, (int)result.Id,adm.Phone, Constant.AdminType, txtPhoneNumber.Text, (int)result.SenderType, DateTime.Now, txtTitle.Text, txtReplyContent.Text, true, false, false, (int)result.SmsTypeId, (int)result.PromotionId);
        Response.Redirect("Default.aspx");
    }
}