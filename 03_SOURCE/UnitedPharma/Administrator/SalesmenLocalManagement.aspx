<%@ Page Title="Salesmen - Local" Language="C#" MasterPageFile="~/Administrator/Admin.master"
    AutoEventWireup="true" CodeFile="SalesmenLocalManagement.aspx.cs" Inherits="Administrator_SalesmenLocalManagement" %>
    ...
    <telerik:RadAjaxManager runat="server" ID="RadAjaxManager1" DefaultLoadingPanelID="RadAjaxLoadingPanel1">
        <AjaxSettings>
            ...
            <telerik:AjaxSetting AjaxControlID="ddlArea">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="ddlLocal" />                    
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="ddlGroup">
                <UpdatedControls>
        ...
        <div style="margin-bottom: 10px;">
            <table>
                <tr>
                    ...
                    <td>Choose an Area:</td>
                    <td>Choose a Local: </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <telerik:RadComboBox Skin="Office2007" ID="ddlLocal" runat="server" OnSelectedIndexChanged="ddlLocal_SelectedIndexChanged"
                            AutoPostBack="true"></telerik:RadComboBox>
                    </td>
                </tr>
            </table>
