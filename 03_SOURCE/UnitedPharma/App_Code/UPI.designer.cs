...
public partial class UPIDataContext : System.Data.Linq.DataContext
{
  ...
  partial void DeletePromotionSearchHistory(PromotionSearchHistory instance);
	...
	public System.Data.Linq.Table<PromotionSearchHistory> PromotionSearchHistories
	{
		get
		{
			return this.GetTable<PromotionSearchHistory>();
		}
	}
...
public partial class SchedulePromotion : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SchedulePromotion_PromotionSearchHistory", Storage="_PromotionSearchHistories", ThisKey="Id", OtherKey="PromotionId")]
...
public partial class PromotionSearchHistory : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	private string _SearchCriteriaLiteral;
	
	private string _SearchResults;
	
	private System.Nullable<System.DateTime> _CreatedDate;
	
	private EntityRef<SchedulePromotion> _SchedulePromotion;
    ...
    partial void OnSearchCriteriaLiteralChanging(string value);
    partial void OnSearchCriteriaLiteralChanged();
	...
	{
		this._SchedulePromotion = default(EntityRef<SchedulePromotion>);
		OnCreated();
	}
	...
	public int PromotionId
	{
		...
		set
		{
			if ((this._PromotionId != value))
			{
				if (this._SchedulePromotion.HasLoadedOrAssignedValue)
				{
					throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
				}
				this.OnPromotionIdChanging(value);
	...
	[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SearchCriteria", DbType="NVarChar(4000) NOT NULL", CanBeNull=false)]
	...
	[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_SearchCriteriaLiteral", DbType="NVarChar(4000) NOT NULL", CanBeNull=false)]
	public string SearchCriteriaLiteral
	{
		get
		{
			return this._SearchCriteriaLiteral;
		}
		set
		{
			if ((this._SearchCriteriaLiteral != value))
			{
				this.OnSearchCriteriaLiteralChanging(value);
				this.SendPropertyChanging();
				this._SearchCriteriaLiteral = value;
				this.SendPropertyChanged("SearchCriteriaLiteral");
				this.OnSearchCriteriaLiteralChanged();
			}
		}
	}
	...
	[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SchedulePromotion_PromotionSearchHistory", Storage="_SchedulePromotion", ThisKey="PromotionId", OtherKey="Id", IsForeignKey=true)]
	public SchedulePromotion SchedulePromotion
	{
		get
		{
			return this._SchedulePromotion.Entity;
		}
		set
		{
			SchedulePromotion previousValue = this._SchedulePromotion.Entity;
			if (((previousValue != value) 
						|| (this._SchedulePromotion.HasLoadedOrAssignedValue == false)))
			{
				this.SendPropertyChanging();
				if ((previousValue != null))
				{
					this._SchedulePromotion.Entity = null;
					previousValue.PromotionSearchHistories.Remove(this);
				}
				this._SchedulePromotion.Entity = value;
				if ((value != null))
				{
				...
				this.SendPropertyChanged("SchedulePromotion");
			}
		}
	}
